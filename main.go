...
var defaultCommands = []CommandSpec{
	...
	// weka_events_major and weka_events_leader_too_slow are generated by
	// buildWindowedDefaultCmds with the collection time window.
	// Do NOT add them here — they need --start-time matching the collection window.
